...
{
    //HBLog(@"didFailToSendPacket, sequenceNumber = %@, error=%@", @(sequenceNumber), error);
    [self endWithFlag:NO];
}
...
{
    //HBLog(@"didReceivePingResponsePacket, sequenceNumber = %@", @(sequenceNumber));
