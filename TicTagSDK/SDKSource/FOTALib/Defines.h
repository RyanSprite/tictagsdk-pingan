...
typedef enum {
    ...
    SPOTAR_BOND_OK          = 0x20,        //设备已经绑定过 bond uuid check ok
    SPOTAR_BOND_FAIL        = 0x21,        //设备已经绑定过 bond uuid check failed
    SPOTAR_NO_BOND          = 0x22,       //设备未被绑定过
    SPOTAR_FOTA_TIMEOUT     = 0x23        //fota超时重启
} SPOTA_STATUS_VALUES;
...
#define SPOTA_REQUEST_IS_BIND_SERVICE_UUID       @"DDCCC62E-9910-0BAC-5241-D8BDA693BBAA"
#define SPOTA_REQUEST_IS_BIND_UUID  @"2D86686A-53DC-25B3-0C4A-F0CC0C8DEE88"
